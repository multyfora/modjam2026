package net.multyfora.modjam.client.model;
...
public class MonocleWornLayer extends RenderLayer<AvatarRenderState, PlayerModel> {
    ...
    public static final StandaloneModelKey<QuadCollection> MODEL_KEY = new StandaloneModelKey<>(
        () -> Identifier.fromNamespaceAndPath(modjam.MODID, "monocle_worn").toString());
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector collector, int lightCoords,
        ...
        if (state.isInvisibleToPlayer || !state.headEquipment.is(modjam.MYSTICAL_MONOCLE.get())) {
            return;
        }
