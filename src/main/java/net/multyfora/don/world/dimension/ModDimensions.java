...
public class ModDimensions {
    public static final ResourceKey<DimensionType> FIRST_CONTACT_TYPE_KEY = ResourceKey.create(
        Registries.DIMENSION_TYPE, Identifier.fromNamespaceAndPath(don.MODID, "first_contact"));
    public static final ResourceKey<LevelStem> FIRST_CONTACT_STEM_KEY = ResourceKey.create(
        Registries.LEVEL_STEM, Identifier.fromNamespaceAndPath(don.MODID, "first_contact"));
    public static final ResourceKey<Level> FIRST_CONTACT_LEVEL_KEY = ResourceKey.create(
        Registries.DIMENSION, Identifier.fromNamespaceAndPath(don.MODID, "first_contact"));
    public static final ResourceKey<Biome> FIRST_CONTACT_BIOME_KEY = ResourceKey.create(
        Registries.BIOME, Identifier.fromNamespaceAndPath(don.MODID, "first_contact"));

    public static final DeferredRegister<Biome> BIOMES =
        DeferredRegister.create(Registries.BIOME, don.MODID);
