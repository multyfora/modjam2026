...
public class BrightestInteractionManager {
    ...
    private static final List<String> DIALOGUE_LINES = List.of(
            "dialogue.don.brightest.1",
            "dialogue.don.brightest.2",
            "dialogue.don.brightest.3",
            "dialogue.don.brightest.4",
            "dialogue.don.brightest.5"
    );
    ...
    private static ModularUI createMenu() {
        ...
        panel.addChild(button("menu.don.brightest.talk", true));
        panel.addChild(button("menu.don.brightest.refuse", false));
    ...
    private static Label title() {
        var label = new Label();
        label.setText(Component.translatable("menu.don.brightest.title").withStyle(Style.EMPTY.withBold(true)));
