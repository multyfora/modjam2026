...
public class JournalGui {
    ...
    private static final Identifier BACKGROUND = Identifier.fromNamespaceAndPath("don", "textures/gui/journal_gui.png");
    private static final Identifier PAGE_FLIP_LEFT = Identifier.fromNamespaceAndPath("don", "textures/gui/page_flip_left_one.png");
    private static final Identifier PAGE_FLIP_LEFT_HOVER = Identifier.fromNamespaceAndPath("don", "textures/gui/page_flip_left_two.png");
    private static final Identifier PAGE_FLIP_RIGHT = Identifier.fromNamespaceAndPath("don", "textures/gui/page_flip_right_one.png");
    private static final Identifier PAGE_FLIP_RIGHT_HOVER = Identifier.fromNamespaceAndPath("don", "textures/gui/page_flip_right_two.png");
    private static final String NOTES_KEY = "don_notes";
    ...
    private static List<Page> buildPages() {
        ...
        if (entries.isEmpty()) {
            return List.of(new Page(null, Component.translatable("journal.don.empty"), Component.empty()));
        }
